...
-(id)init;
-(void)addObserver:(id<WATodayModelObserver>)observer;
-(void)removeObserver:(id)arg1 ;
-(id)location;
-(NSDate *)lastUpdateDate;
-(id)initWithLocation:(id)arg1 ;
-(void)_locationUpdateCompleted:(id)arg1 error:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)_executeLocationUpdateWithCompletion:(void(^)(void))arg1 ;
...
-(BOOL)executeModelUpdateWithCompletion:(void(^)(void))arg1 ;
